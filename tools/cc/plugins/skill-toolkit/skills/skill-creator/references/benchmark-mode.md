...
${CLAUDE_PLUGIN_ROOT}/skills/skill-creator/scripts/aggregate_benchmark.py <benchmark-dir> --skill-name <name> --skill-path <path>
```
...
${CLAUDE_PLUGIN_ROOT}/skills/skill-creator/scripts/validate_json.py <benchmark-dir>/benchmark.json

# Validate individual grading files
${CLAUDE_PLUGIN_ROOT}/skills/skill-creator/scripts/validate_json.py <run-dir>/grading.json --type grading
```
...
${CLAUDE_PLUGIN_ROOT}/skills/skill-creator/scripts/init_json.py benchmark <benchmark-dir>/benchmark.json
```

## Analyzer Instructions

The analyzer (always most capable) reviews all results and generates freeform notes. See `${CLAUDE_PLUGIN_ROOT}/skills/skill-creator/agents/analyzer.md` for the full prompt, but key responsibilities:
